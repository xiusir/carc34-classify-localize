...
tf.app.flags.DEFINE_string('train_dir', '%s/tmp/carc34_train.classify' % tf_home,
                           ...
                           """and checkpoint.""")
tf.app.flags.DEFINE_string('train_dir_save', '%s/tmp/carc34_train.classify/save' % tf_home,
                           """Directory where to write event logs """
                           """and checkpoint.""")
...
tf.app.flags.DEFINE_string('eval_dir', '%s/tmp/carc34_eval' % tf_home,
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '%s/tmp/carc34_train.classify' % tf_home,
