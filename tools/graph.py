...
with tf.Graph().as_default() as graph:
    model_filename = os.path.join('.', 'optimized_carc34_v0.9.0.pb')
    model_filename = os.path.join('.', 'frozen_carc34_v0.9.0.pb')
    model_filename = os.path.join('.', 'bazel_carc34_v0.9.0.pb')
    model_filename = os.path.join('.', 'inference.pb')
    model_filename = os.path.join('.', 'image_preproc.pb')
    model_filename = os.path.join('.', 'bazel.pb')
    model_filename = os.path.join('.', 'frozen.pb')
